...
export const zim = async (req: Request, res: Response) => {
  ...
  try {
    ...
    try {
      let api_zim_res = await axios.get(`http://3.129.16.6:5001//zim?data_saida=${data_saida_zim}&porto_embarque=${porto_embarque}&porto_descarga=${porto_descarga}&tipo_container=${tipo_container}`)
