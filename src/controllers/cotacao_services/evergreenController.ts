...
export const evergreen = async (req: Request, res: Response) => {
  ...
  try {
    ...
    try {
      let api_evergreen_res = await axios.get(`http://18.218.30.7:5001/evergreen?data_saida=${data_saida_evergreen}&porto_embarque=${porto_embarque}&porto_descarga=${porto_descarga}&tipo_container=${tipo_container}`)
