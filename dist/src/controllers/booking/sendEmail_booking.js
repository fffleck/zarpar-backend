...
const send_email = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        <tbody>
            ...
            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                <div class="v-font-size" style="line-height: 140%; text-align: left; word-wrap: break-word;">
                    ...
                    <p style="line-height: 19.6px;"><strong>Data do Pedido de Booking:</strong> ${(0, moment_1.default)(informacoesEmail.created_at).format('DD/MM/YYYY')}</p>
                </div>
            </td>
            </tr>
        </tbody>
